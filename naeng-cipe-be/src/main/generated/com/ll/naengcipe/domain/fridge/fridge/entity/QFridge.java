...
public class QFridge extends EntityPathBase<Fridge> {
    ...
    public final ListPath<FridgeIngredient, QFridgeIngredient> fridgeIngredient = this.<FridgeIngredient, QFridgeIngredient>createList("fridgeIngredient", FridgeIngredient.class, QFridgeIngredient.class, PathInits.DIRECT2);
